    ...
    */
    ...
    if(isset($_POST['submit'])){
        ...
        if(!checkCodeExists($connection,$code)){
            if(productAdd($connection,$name,$code,$mrp,$quantityType,$date)){
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edgfe,chrome=1" />

    <title>Products Add | Store Management</title>
                                ...
                                <form method="post" onSubmit="return check();">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Code</label>
                                                <input type="text" class="form-control" placeholder="Product code (Ex: SOAP001)" required="" name="code">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="quantityType" required="">
                                                    <option name="quantityType" value="">Select type</option>
