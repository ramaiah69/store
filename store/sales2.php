<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(!$error && purchaseAdd($connection,$id,$totalItems,$discount,$discountType,$tax,$price,$shopKeeperEmail,$note,$date)){
    ...
    $.ajax({
                ...
                success: function (response) {
                   ...
                   var i = 0;
                    ...
                    text += '<td> <input id="inputUnitPrice'+sno+'" name="inputUnitPrice'+sno+'" value="'+response[0]['mrp']+'"   class="form-control col-md-1" /> </td><td><input class="form-control" type="text" onkeyup="calculateTotalAmount('+"'"+sno+"'"+')" name="inputQuantity'+sno+'" id="inputQuantity'+sno+'" value="1"/></td><td><div class="col-md-5"><input class="form-control " name="inputDiscount'+sno+'" id="inputDiscount'+sno+'" value="0" /></div><div class="col-md-6"><select onChange="updateDiscount('+sno+')" class="form-control " name="inputDiscountType'+sno+'" id="inputDiscountType'+sno+'" ><option value="%" name="inputDiscountType'+sno+'">%</option><option value="rupees" name="inputDiscountType'+sno+'">Rupees</option></select></div></td><td> <input class="form-control" id="inputTotalPrice'+sno+'" name="inputTotalPrice'+sno+'" value="'+response[0]['mrp']+'"  /></td>';
                    tr.innerHTML = text;
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 pull-right">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control col-md-2" placeholder="total price"   name="totalPrice" id="totalPrice" value="" disabled="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
