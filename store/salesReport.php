...
<head>
	...
	<title>Sales Report | Strore Management</title>
                            ...
                            <div class="content">
                                <form method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Shop Keeper</label>
                                                <select name="shopKeeperEmail" class="form-control">
                                                    <option name="shopKeeperEmail" value="all">All</option>
                                                    <?php
                                                        $query = mysql_query("select * from users");
                                                        while($row = mysql_fetch_assoc($query)){
                                                            echo '<option name="shopKeeperEmail" value="'.$row['email'].'">'.$row['name'].'</option>';
                                                        }
                                                    ?>
                                                </select>
                            ...
                            <div class="content table-responsive table-full-width">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                                if(isset($_POST['shopKeeperEmail'])){
                                                    $a = $_POST['shopKeeperEmail'];
                                                    $b = $_POST['date'];
                                                    if($a != "all"){
                                                        if($b != "all"){
                                                        ...
                                                        if($b != "all"){
                                                            echo "All shop keepers <b>$b</b> Reports";
                                                        }else{
                                                            echo "All shop keepers <b>Total</b> Reports";
                                                        }
                                                    }
                                                }
                                    ...
                                    <tbody>
                                        <?php
                                            if(isset($_POST['submit'])){
                                                $date = $_POST['date'];
                                                $shopKeeperEmail = $_POST['shopKeeperEmail'];
                                                if($date == "today"){
                                                ...
                                                if(mysql_num_rows($query)){
                                                    while($row = mysql_fetch_assoc($query)){
                                                        echo '<tr>';
                                                            echo '<td>'.$i.'</td><td><a target="_blank" href="individualSaleDetails.php?id='.$row['id'].'">'.$row['id'].'</a></td><td>'.$row['totalItems'].'</td>';
