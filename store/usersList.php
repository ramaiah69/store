...
<head>
    <script type="text/javascript">
        function changeUserStatus(email,type){
            if(check()){
                $.ajax({
	...
	<title>Products List | Strore Management</title>
                                            ...
                                            while($row = mysql_fetch_assoc($query)){
                                                echo "<tr>";
                                                    ...
                                                    if($row['role'] == 1){
                                                        ...
                                                        echo '<td>Shop Keeper</td>';
                                                    }
                                                    if($row['status'] == 1){
                                                        echo '<td><a href="#" onclick="changeUserStatus('."'".$row['email']."','deactivate'".')" title="Click to deactive">Active</td>';
                                                    }else{
                                                        echo '<td><a href="#" onclick="changeUserStatus('."'".$row['email']."','activate'".')" title="Click to activate">Deactivate</td>';
                                                    }
