<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = mysql_query("insert into users (name,email,password,date) values ('$name','$email','$password','$date')");
        if($query){
            $error = '<b>Reigstration success</b>';
        }else{
            $error = '<b>Reigstration failed</b>';
        }
    }
?>
<!doctype html>
...
<head>
	...
	<title>Store Management | Register</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <div class="row">
                                    <div class="col-md-6" style="margin-top: 10px"><a href="login.php">Login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
